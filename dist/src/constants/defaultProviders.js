...
exports.PROVIDER_GROUPS = exports.defaultProviders = void 0;
exports.getProviderGroup = getProviderGroup;
/**
 ...
 */
function getProviderGroup(option) {
    if (!option) {
        return 'Other';
    }
    let id = '';
    ...
    for (const prefix in exports.PROVIDER_GROUPS) {
        if (id && typeof id === 'string' && id.indexOf(prefix) === 0) {
            return exports.PROVIDER_GROUPS[prefix];
        }
    }
    return 'Other';
}
