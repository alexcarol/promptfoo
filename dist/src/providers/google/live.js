...
exports.GoogleLiveProvider = exports.tryGetThenPost = exports.fetchJson = void 0;
...
const fetchJson = async (url, options) => {
    const response = await (0, index_1.fetchWithProxy)(url, options);
    if (!response.ok) {
...
const tryGetThenPost = async (url, data) => {
    try {
        ...
        return await (0, exports.fetchJson)(urlWithParams.href);
    }
    catch {
        // Fall back to POST
        return (0, exports.fetchJson)(url, {
            method: 'POST',
            headers: {
...
exports.tryGetThenPost = tryGetThenPost;
            ...
            const finalizeResponse = async () => {
                ...
                if (this.config.functionToolStatefulApi) {
                    try {
                        ...
                        statefulApiState = await (0, exports.fetchJson)(url);
                                ...
                                try {
                                    if (this.config.functionToolCallbacks?.[functionName]) {
                                        ...
                                        const baseUrl = new URL(functionName, this.config.functionToolStatefulApi.url)
                                            .href;
                                        try {
                                            callbackResponse = await (0, exports.tryGetThenPost)(baseUrl, functionCall.args);
