...
async function fetchModelSpecs() {
    try {
        const { data, cached: _cached, latencyMs: _latencyMs, } = await (0, cache_1.fetchWithCache)('https://us-south.ml.cloud.ibm.com/ml/v1/foundation_model_specs?version=2023-09-30', {
            headers: {
    ...
    async callApi(prompt) {
        ...
        if (cacheEnabled) {
            ...
            if (cachedResponse) {
                ...
                const resp = JSON.parse(cachedResponse);
