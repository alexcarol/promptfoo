...
class OllamaChatProvider {
    ...
    async callApi(prompt, context) {
        ...
        logger_1.default.debug('[Ollama Chat] Calling Ollama API', { params });
        let response;
        try {
        ...
        logger_1.default.debug('[Ollama Chat] API response received', {
        ...
        try {
            ...
            const chunkWithToolCalls = lines.find((chunk) => chunk.message?.tool_calls && chunk.message.tool_calls.length > 0);
            ...
            if (tool_calls && tool_calls.length > 0) {
                ...
                logger_1.default.debug('[Ollama Chat] Tool calls detected', {
