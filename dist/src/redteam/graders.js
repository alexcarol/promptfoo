...
const ferpa_1 = require("./plugins/compliance/ferpa");
...
const goalMisalignment_1 = require("./plugins/goalMisalignment");
...
const coverageDiscrimination_1 = require("./plugins/insurance/coverageDiscrimination");
const networkMisinformation_1 = require("./plugins/insurance/networkMisinformation");
const phiDisclosure_1 = require("./plugins/insurance/phiDisclosure");
...
const controlledSubstanceCompliance_1 = require("./plugins/pharmacy/controlledSubstanceCompliance");
const dosageCalculation_1 = require("./plugins/pharmacy/dosageCalculation");
const drugInteraction_1 = require("./plugins/pharmacy/drugInteraction");
const overreliance_1 = require("./plugins/overreliance");
const pii_1 = require("./plugins/pii");
const pliny_1 = require("./plugins/pliny");
const index_1 = require("./plugins/policy/index");
...
exports.GRADERS = {
    ...
    'promptfoo:redteam:ferpa': new ferpa_1.FerpaGrader(),
    ...
    'promptfoo:redteam:goal-misalignment': new goalMisalignment_1.GoalMisalignmentGrader(),
    ...
    'promptfoo:redteam:insurance:coverage-discrimination': new coverageDiscrimination_1.InsuranceCoverageDiscriminationPluginGrader(),
    'promptfoo:redteam:insurance:network-misinformation': new networkMisinformation_1.InsuranceNetworkMisinformationPluginGrader(),
    'promptfoo:redteam:insurance:phi-disclosure': new phiDisclosure_1.InsurancePhiDisclosurePluginGrader(),
    ...
    'promptfoo:redteam:pharmacy:controlled-substance-compliance': new controlledSubstanceCompliance_1.PharmacyControlledSubstanceCompliancePluginGrader(),
    'promptfoo:redteam:pharmacy:dosage-calculation': new dosageCalculation_1.PharmacyDosageCalculationPluginGrader(),
    'promptfoo:redteam:pharmacy:drug-interaction': new drugInteraction_1.PharmacyDrugInteractionPluginGrader(),
    ...
    'promptfoo:redteam:policy': new index_1.PolicyViolationGrader(),
