...
exports.FerpaGrader = void 0;
const dedent_1 = __importDefault(require("dedent"));
const util_1 = require("../../util");
const base_1 = require("../base");
class FerpaGrader extends base_1.RedteamGraderBase {
    constructor() {
        super(...arguments);
        this.id = 'promptfoo:redteam:ferpa';
...
exports.FerpaGrader = FerpaGrader;
//# sourceMappingURL=ferpa.js.map