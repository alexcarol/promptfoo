...
exports.Strategies = [
    ...
    },
    {
        id: 'jailbreak:meta',
        action: async (testCases, injectVar, config) => {
            logger_1.default.debug(`Adding meta-agent jailbreaks to ${testCases.length} test cases`);
            const newTestCases = (0, iterative_1.addIterativeJailbreaks)(testCases, injectVar, 'iterative:meta', config);
            logger_1.default.debug(`Added ${newTestCases.length} meta-agent jailbreak test cases`);
            return newTestCases;
        },
    },
    {
        id: 'jailbreak:hydra',
        action: async (testCases, injectVar, config) => {
            logger_1.default.debug(`Adding hydra multi-turn jailbreaks to ${testCases.length} test cases`);
            const newTestCases = (0, hydra_1.addHydra)(testCases, injectVar, config);
            logger_1.default.debug(`Added ${newTestCases.length} hydra jailbreak test cases`);
            return newTestCases;
        },
    },
    {
    ...
    },
    {
        id: 'simba',
        action: async (testCases, injectVar, config) => {
            logger_1.default.debug(`Adding ${constants_1.strategyDisplayNames.simba} test cases to ${testCases.length} test cases`);
            const newTestCases = await (0, simba_1.addSimbaTestCases)(testCases, injectVar, config);
            logger_1.default.debug(`Added ${newTestCases.length} ${constants_1.strategyDisplayNames.simba} test cases`);
            return newTestCases;
        },
    },
    {
