...
function getConcurrencyLimit(config = {}) {
    ...
    if (!Number.isFinite(n) || n <= 0) {
        return constants_1.DEFAULT_MAX_CONCURRENCY;
    }
...
async function addMultilingual(testCases, injectVar, config) {
    ...
    logger_1.default.debug('[DEPRECATED] The "multilingual" strategy is deprecated. Use the top-level "language" config instead. See: https://www.promptfoo.dev/docs/red-team/configuration/#language');
    ...
    if (hasLanguageModifiers) {
        ...
        logger_1.default.debug(`Multilingual strategy: ${testCases.length} tests already generated with language support`);
        return testCases;
    }
