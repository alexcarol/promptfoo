...
const executable_1 = require("./processors/executable");
...
async function processPrompt(prompt, basePath = '', maxRecursionDepth = 1) {
    ...
    if (prompt.raw.startsWith('exec:')) {
        ...
        const { filePath, functionName } = (0, index_1.parsePathOrGlob)(basePath, execSpec);
        return await (0, executable_1.processExecutableFile)(filePath, prompt, functionName);
    }
