...
exports.testProviderConnectivity = testProviderConnectivity;
 ...
 */
async function testProviderConnectivity(provider, prompt = 'Hello World!') {
    const vars = {};
    ...
    try {
        ...
        try {
            ...
            const testAnalyzerResponse = await (0, index_1.fetchWithProxy)(`${HOST}/api/v1/providers/test`, {
                method: 'POST',
                headers: {
