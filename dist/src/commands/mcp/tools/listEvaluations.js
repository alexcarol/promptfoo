...
function registerListEvaluationsTool(server) {
    server.tool('list_evaluations', {
        datasetId: zod_1.z
            .string()
            .optional()
            .describe('Filter evaluations by dataset ID (SHA256 hash). Example: "0e65b35936119614815dfb3a2bd2c09863d8abbcd32d0cae1e98902b04b5df4e" or leave empty to see all evaluations'),
        page: zod_1.z
            .number()
            .int()
            .positive()
