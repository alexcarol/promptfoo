...
exports.handleExampleDownload = handleExampleDownload;
    ...
    try {
        ...
        if (!dirAlreadyExists) {
            try {
                ...
                logger_1.default.error(`Failed to remove directory: ${error}`);
            }
        }
    ...
    while (attemptDownload && exampleName) {
        ...
        try {
          ...
          No example downloaded. To get started, try:
            ...
            ${chalk_1.default.bold('promptfoo init --example')}    (browse and select an example)
            ${chalk_1.default.bold('promptfoo init')}              (create a basic project)
