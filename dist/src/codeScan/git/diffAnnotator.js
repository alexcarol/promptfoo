...
exports.annotateSingleFileDiffWithLineNumbers = annotateSingleFileDiffWithLineNumbers;
/**
 ...
 * ```
 */
function annotateSingleFileDiffWithLineNumbers(patch) {
    if (!patch || patch.trim() === '') {
        return patch;
    }
...
//# sourceMappingURL=diffAnnotator.js.map