...
exports.ProviderEnvOverridesSchema = zod_1.z.object({
    ...
    SHAREPOINT_BASE_URL: zod_1.z.string().optional(),
    SHAREPOINT_CERT_PATH: zod_1.z.string().optional(),
    SHAREPOINT_CLIENT_ID: zod_1.z.string().optional(),
    SHAREPOINT_TENANT_ID: zod_1.z.string().optional(),
