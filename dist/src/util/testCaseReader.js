...
const microsoftSharepoint_1 = require("../microsoftSharepoint");
...
async function readStandaloneTestsFile(varsPath, basePath = '', config) {
    ...
    if (varsPath.startsWith('https://docs.google.com/spreadsheets/')) {
        ...
        rows = await (0, microsoftSharepoint_1.fetchCsvFromSharepoint)(varsPath);
    }
        ...
        rows = await (0, xlsx_1.parseXlsxFile)(resolvedVarsPath);
    }
