...
describe('renderPrompt with skipRenderVars', () => {
    it('should skip rendering variables in skipRenderVars array', async () => {
        ...
        const resultWithoutSkip = await (0, evaluatorHelpers_1.renderPrompt)(prompt, vars);
        expect(resultWithoutSkip).toBe('User input: 49');
        // With skipRenderVars - variable value is NOT rendered
        const resultWithSkip = await (0, evaluatorHelpers_1.renderPrompt)(prompt, vars, {}, undefined, ['user_input']);
    ...
    it('should pass SSTI payloads through without evaluation when skipped', async () => {
        ...
        const result = await (0, evaluatorHelpers_1.renderPrompt)(prompt, vars, {}, undefined, ['payload']);
...
//# sourceMappingURL=evaluatorHelpers-skiprender.test.js.map