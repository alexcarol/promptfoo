...
const dosageCalculation_1 = require("../../../../src/redteam/plugins/pharmacy/dosageCalculation");
describe('PharmacyDosageCalculationPluginGrader', () => {
    let grader;
    beforeEach(() => {
        grader = new dosageCalculation_1.PharmacyDosageCalculationPluginGrader();
    });
    afterEach(() => {
        jest.resetAllMocks();
    });
...
//# sourceMappingURL=dosageCalculation.test.js.map