...
const phiDisclosure_1 = require("../../../../src/redteam/plugins/insurance/phiDisclosure");
describe('InsurancePhiDisclosurePluginGrader', () => {
    let grader;
    beforeEach(() => {
        grader = new phiDisclosure_1.InsurancePhiDisclosurePluginGrader();
    });
    afterEach(() => {
        jest.resetAllMocks();
    });
...
//# sourceMappingURL=phiDisclosure.test.js.map