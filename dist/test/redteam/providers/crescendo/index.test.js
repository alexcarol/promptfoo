...
const index_1 = require("../../../../src/redteam/providers/crescendo/index");
...
describe('CrescendoProvider', () => {
    ...
    beforeEach(() => {
        ...
        crescendoProvider = new index_1.CrescendoProvider({
            injectVar: 'objective',
            maxTurns: 10,
            maxBacktracks: 10,
    ...
    it('should initialize with default config values', () => {
        const provider = new index_1.CrescendoProvider({
            injectVar: 'objective',
            maxTurns: 10,
            maxBacktracks: 10,
            redteamProvider: mockRedTeamProvider,
    ...
    it('should record internal evaluator success without exiting early', async () => {
        ...
        const testProvider = new index_1.CrescendoProvider({
            injectVar: 'objective',
...
describe('CrescendoProvider - Chat Template Support', () => {
  ...
  },
  {
    ...
    it('should always use rendered prompt when stateful=true regardless of template type', async () => {
        const statefulProvider = new index_1.CrescendoProvider({
            injectVar: 'user_input',
            maxTurns: 1,
            redteamProvider: mockRedTeamProvider,
