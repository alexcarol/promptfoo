...
const index_3 = require("../../src/redteam/plugins/index");
const remoteGeneration_1 = require("../../src/redteam/remoteGeneration");
const index_4 = require("../../src/redteam/strategies/index");
...
describe('synthesize', () => {
    ...
    beforeEach(() => {
        ...
        jest.mocked(index_4.validateStrategies).mockImplementation(async () => { });
    ...
    describe('Plugins and strategies', () => {
        it('should generate test cases for each plugin', async () => {
            ...
            jest.spyOn(index_3.Plugins, 'find').mockReturnValue({ action: mockPluginAction, key: 'mockPlugin' });
            const result = await (0, index_2.synthesize)({
                language: 'en',
                numTests: 1,
                plugins: [
        ...
        it('should warn about unregistered plugins', async () => {
            jest.spyOn(index_3.Plugins, 'find').mockReturnValue(undefined);
            await (0, index_2.synthesize)({
                language: 'en',
                numTests: 1,
        ...
        it('should use default fan-out values when strategy config omits n', async () => {
            ...
            const strategyFindSpy = jest.spyOn(index_4.Strategies, 'find').mockImplementation((predicate) => {
        ...
        it('should expand strategy collections into individual strategies', async () => {
            ...
            jest.spyOn(index_3.Plugins, 'find').mockReturnValue({ action: mockPluginAction, key: 'mockPlugin' });
            const mockStrategyAction = jest.fn().mockReturnValue([{ test: 'strategy case' }]);
            jest.spyOn(index_4.Strategies, 'find').mockImplementation((s) => {
            ...
            expect(index_4.validateStrategies).toHaveBeenCalledWith(expect.any(Array));
        });
        it('should deduplicate strategies with the same ID', async () => {
            ...
            const validateStrategiesSpy = jest.mocked(index_4.validateStrategies);
        ...
        it('should find exact strategy IDs like jailbreak:composite', async () => {
            ...
            jest.spyOn(index_4.Strategies, 'find').mockImplementation((predicate) => {
                if (typeof predicate === 'function') {
                    const strategies = [
                        {
                            id: 'jailbreak',
        ...
        it('should warn when strategy is not found', async () => {
            ...
            jest.spyOn(index_4.Strategies, 'find').mockReturnValue(undefined);
            await (0, index_2.synthesize)({
                language: 'en',
                numTests: 1,
                plugins: [{ id: 'test-plugin', numTests: 1 }],
        ...
        it('should not store full config in metadata for intent plugin to prevent bloating', async () => {
            ...
            jest.spyOn(index_3.Plugins, 'find').mockImplementation((predicate) => {
                const mockPlugins = [
    ...
    it('should handle basic strategy configuration', async () => {
        ...
        jest.spyOn(index_3.Plugins, 'find').mockReturnValue({
            key: 'test-plugin',
    ...
    describe('Direct plugin handling', () => {
        it('should recognize and not expand direct plugins like bias:gender', async () => {
            ...
            jest.spyOn(index_3.Plugins, 'find').mockReturnValue({ key: 'bias:gender', action: mockPluginAction });
            const result = await (0, index_2.synthesize)({
                language: 'en',
                numTests: 2,
        ...
        it('should still expand category plugins with new bias category', async () => {
            const mockPluginAction = jest.fn().mockResolvedValue([{ vars: { query: 'test' } }]);
            jest.spyOn(index_3.Plugins, 'find').mockReturnValue({ key: 'mockPlugin', action: mockPluginAction });
            const result = await (0, index_2.synthesize)({
                language: 'en',
                numTests: 1,
...
describe('Language configuration', () => {
    ...
    describe('calculateTotalTests with language', () => {
        it('should calculate correct test count for single language', () => {
            ...
            const result = (0, index_2.calculateTotalTests)(plugins, [], 'en');
            expect(result).toEqual({
                totalTests: 5,
                totalPluginTests: 5,
                effectiveStrategyCount: 0,
        ...
        it('should calculate correct test count for multiple languages', () => {
            ...
            const result = (0, index_2.calculateTotalTests)(plugins, [], ['en', 'fr', 'de']);
            expect(result).toEqual({
                totalTests: 15,
                totalPluginTests: 15,
                effectiveStrategyCount: 0,
        ...
        it('should calculate correct test count with strategies and multiple languages', () => {
            ...
            // Total: 30
            const result = (0, index_2.calculateTotalTests)(plugins, strategies, ['en', 'fr', 'de']);
            expect(result).toEqual({
                totalTests: 30,
                totalPluginTests: 15,
                effectiveStrategyCount: 1,
        ...
        it('should handle layer strategy with multiple languages', () => {
            ...
            const result = (0, index_2.calculateTotalTests)(plugins, strategies, ['en', 'fr']);
            expect(result).toEqual({
                totalTests: 20,
                totalPluginTests: 10,
                effectiveStrategyCount: 1,
    ...
    describe('synthesize with language configuration', () => {
        ...
        it('should generate test cases for each language when multiple languages specified', async () => {
            ...
            const languageCounts = result.testCases.reduce((acc, tc) => {
        ...
        it('should apply strategies to multilingual test cases', async () => {
            ...
            jest.spyOn(index_4.Strategies, 'find').mockReturnValue({
                id: 'rot13',
