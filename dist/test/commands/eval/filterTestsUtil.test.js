...
const util = __importStar(require("../../../src/util/index"));
    ...
    describe('filterTestsByResults', () => {
        ...
        describe('with file path', () => {
            ...
            it('should filter tests based on failure reason', async () => {
                const result = await (0, filterTestsUtil_1.filterTestsByResults)(mockTestSuite, 'results.json', (result) => result.failureReason === index_1.ResultFailureReason.ERROR);
                expect(result).toHaveLength(1);
        ...
        describe('with eval ID', () => {
            ...
            it('should filter tests based on failure reason', async () => {
                const result = await (0, filterTestsUtil_1.filterTestsByResults)(mockTestSuite, 'eval-123', (result) => result.failureReason === index_1.ResultFailureReason.ERROR);
                expect(result).toHaveLength(1);
                expect(result[0]?.vars?.var1).toBe('test3');
            });
