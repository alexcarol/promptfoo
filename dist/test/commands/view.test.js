...
describe('viewCommand', () => {
    ...
    it('should register view command with correct options', () => {
        ...
        expect(options).toEqual({
            port: (0, constants_1.getDefaultPort)(),
        });
    });
    ...
    it('should handle browser behavior options correctly', async () => {
        ...
        expect(server_1.startServer).toHaveBeenCalledWith((0, constants_1.getDefaultPort)(), server_2.BrowserBehavior.OPEN);
        jest.clearAllMocks();
    ...
    it('should ignore filter description option', async () => {
        ...
        expect(server_1.startServer).toHaveBeenCalledWith((0, constants_1.getDefaultPort)(), server_2.BrowserBehavior.ASK);
    });
