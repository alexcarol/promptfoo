...
describe('loadApiProvider', () => {
    ...
    it('should load Provider from cloud', async () => {
        ...
        expect(provider).toBeDefined();
        expect(pythonCompletion_1.PythonProvider).toHaveBeenCalledWith(expect.stringMatching(/custom_provider\.py/), expect.objectContaining({
            config: expect.objectContaining({
                apiKey: 'test-key',
                temperature: 0.7,
            }),
    ...
    it('should merge local config overrides with cloud provider config', async () => {
        ...
        expect(provider).toBeDefined();
        expect(pythonCompletion_1.PythonProvider).toHaveBeenCalledWith(expect.stringMatching(/custom_llm\.py/), expect.objectContaining({
            config: expect.objectContaining({
    ...
    it('should merge cloud provider env with local env overrides', async () => {
        ...
        expect(provider).toBeDefined();
        expect(pythonCompletion_1.PythonProvider).toHaveBeenCalledWith(expect.stringMatching(/external_api\.py/), expect.objectContaining({
    ...
    it('should preserve cloud provider config when no local overrides provided', async () => {
        ...
        const provider = await (0, index_1.loadApiProvider)(`${constants_1.CLOUD_PROVIDER_PREFIX}123`);
        expect(provider).toBeDefined();
        expect(pythonCompletion_1.PythonProvider).toHaveBeenCalledWith(expect.stringMatching(/secure_llm\.py/), expect.objectContaining({
            config: expect.objectContaining({
                apiKey: 'cloud-key',
                temperature: 0.8,
            }),
    ...
    it('should handle cloud provider with empty local config override', async () => {
        ...
        expect(provider).toBeDefined();
        expect(pythonCompletion_1.PythonProvider).toHaveBeenCalledWith(expect.stringMatching(/inference\.py/), expect.objectContaining({
            config: expect.objectContaining({
                apiKey: 'cloud-key',
                temperature: 0.7,
            }),
