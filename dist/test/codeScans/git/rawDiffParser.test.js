...
const rawDiffParser_1 = require("../../../src/codeScan/git/rawDiffParser");
describe('parseRawDiff', () => {
    describe('basic file operations', () => {
        it('should parse modified files correctly', () => {
            ...
            const result = (0, rawDiffParser_1.parseRawDiff)(rawOutput);
        ...
        it('should parse added files correctly', () => {
            const rawOutput = ':000000 100644 0000000000000000000000000000000000000000 abc123 A\0src/new.ts\0';
            const result = (0, rawDiffParser_1.parseRawDiff)(rawOutput);
            expect(result).toHaveLength(1);
            expect(result[0]).toEqual({
                path: 'src/new.ts',
        ...
        it('should parse deleted files correctly', () => {
            const rawOutput = ':100644 000000 abc123 0000000000000000000000000000000000000000 D\0src/old.ts\0';
            const result = (0, rawDiffParser_1.parseRawDiff)(rawOutput);
            expect(result).toHaveLength(1);
            expect(result[0]).toEqual({
                path: 'src/old.ts',
    ...
    describe('edge cases', () => {
        it('should handle empty input', () => {
            const result = (0, rawDiffParser_1.parseRawDiff)('');
...
//# sourceMappingURL=rawDiffParser.test.js.map