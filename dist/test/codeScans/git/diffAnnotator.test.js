...
const diffAnnotator_1 = require("../../../src/codeScan/git/diffAnnotator");
describe('annotateDiffWithLineNumbers', () => {
    describe('basic functionality', () => {
        it('should handle empty patch', () => {
            expect((0, diffAnnotator_1.annotateSingleFileDiffWithLineNumbers)('')).toBe('');
            expect((0, diffAnnotator_1.annotateSingleFileDiffWithLineNumbers)('   ')).toBe('   ');
        });
...
--- a/test.ts
+++ b/test.ts`;
            const result = (0, diffAnnotator_1.annotateSingleFileDiffWithLineNumbers)(patch);
...
//# sourceMappingURL=diffAnnotator.test.js.map