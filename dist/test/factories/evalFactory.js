...
const index_2 = require("../../src/database/index");
...
class EvalFactory {
    ...
    static async addCustomResult(eval_, options) {
        ...
        if (resultType === 'error') {
            ...
            result.failureReason = index_1.ResultFailureReason.ERROR;
        }
        else {
            result.error = null;
            result.failureReason =
                resultType === 'success' ? index_1.ResultFailureReason.NONE : index_1.ResultFailureReason.ASSERT;
        }
