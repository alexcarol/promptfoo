...
(E) The answers differ, but these differences don't matter from the perspective of factuality.`,
        ...
        expect(mockCallApi).toHaveBeenCalledWith(expect.stringContaining('The submitted answer may either be a subset or superset of the expert answer'), expect.any(Object));
    });
    ...
    it('should use Nunjucks templating when PROMPTFOO_DISABLE_TEMPLATING is set', async () => {
        ...
        expect(defaults_1.DefaultGradingProvider.callApi).toHaveBeenCalledWith(expect.any(String), expect.objectContaining({
