...
describe('matchesGEval', () => {
    ...
    it('should handle custom rubric prompts', async () => {
        ...
        expect(mockCallApi).toHaveBeenNthCalledWith(1, expect.stringContaining('Custom steps template with'), expect.any(Object));
        expect(mockCallApi).toHaveBeenNthCalledWith(2, expect.stringContaining('Custom evaluation template with'), expect.any(Object));
        defaults_1.DefaultGradingProvider.callApi = originalCallApi;
    });
