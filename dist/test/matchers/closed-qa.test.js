...
describe('matchesClosedQa', () => {
    ...
    it('should use Nunjucks templating when PROMPTFOO_DISABLE_TEMPLATING is set', async () => {
        ...
        expect(defaults_1.DefaultGradingProvider.callApi).toHaveBeenCalledWith(expect.stringContaining('Input {{ var }}'), expect.any(Object));
        expect(defaults_1.DefaultGradingProvider.callApi).toHaveBeenCalledWith(expect.stringContaining('Expected {{ var }}'), expect.any(Object));
        expect(defaults_1.DefaultGradingProvider.callApi).toHaveBeenCalledWith(expect.stringContaining('Output {{ var }}'), expect.any(Object));
...
Does the answer meet the criteria? Answer Y or N.`;
        ...
        const result = await (0, matchers_1.matchesClosedQa)(input, expected, output, grading);
