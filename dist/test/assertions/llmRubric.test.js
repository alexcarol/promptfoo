...
describe('handleLlmRubric', () => {
    ...
    it('should handle string rendered value', async () => {
        ...
        expect(mockMatchesLlmRubric).toHaveBeenCalledWith('test rendered value', 'test output string', undefined, {}, params.assertion, undefined, undefined);
    });
    it('should handle object rendered value', async () => {
        ...
        const result = await (0, llmRubric_1.handleLlmRubric)(params);
        expect(result).toEqual(expectedResult);
        expect(mockMatchesLlmRubric).toHaveBeenCalledWith({ test: 'value' }, 'test output string', undefined, {}, params.assertion, undefined, undefined);
    });
    it('should handle undefined rendered value', async () => {
        ...
        const result = await (0, llmRubric_1.handleLlmRubric)(params);
        expect(result).toEqual(expectedResult);
        expect(mockMatchesLlmRubric).toHaveBeenCalledWith('', 'test output string', undefined, {}, params.assertion, undefined, undefined);
    });
    ...
    it('should handle renderedValue as an array', async () => {
        ...
        const result = await (0, llmRubric_1.handleLlmRubric)(params);
        expect(result).toEqual(expectedResult);
        expect(mockMatchesLlmRubric).toHaveBeenCalledWith(['foo', 'bar'], 'test output string', undefined, {}, params.assertion, undefined, undefined);
    });
});
