...
describe('JavaScript file references', () => {
    ...
    it('should handle JavaScript file reference with function name', async () => {
        ...
        const mockFn = jest.fn((_output) => true);
        ...
        jest.mocked(esm_1.importModule).mockImplementationOnce((_path, _functionName) => {
            return Promise.resolve({
    ...
    it.each([
        ...
        [
            'GradingResult',
            jest.fn((_output) => ({ pass: true, score: 1, reason: 'Custom reason' })),
            true,
            'Custom reason',
        ],
        [
        ...
        ['number', jest.fn((_output) => 0), false, 'Custom function returned false'],
        [
            'GradingResult',
            jest.fn((_output) => ({ pass: false, score: 0.1, reason: 'Custom reason' })),
            false,
            'Custom reason',
        ],
        [
            'boolean Promise',
            jest.fn((_output) => Promise.resolve(true)),
            true,
            'Assertion passed',
        ],
