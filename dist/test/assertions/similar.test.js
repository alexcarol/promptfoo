...
const similar_1 = require("../../src/assertions/similar");
...
describe('handleSimilar', () => {
    it('should handle string similarity assertion', async () => {
        const result = await (0, similar_1.handleSimilar)({
            assertion: {
                type: 'similar',
                value: 'hello world',
            },
    ...
    it('should throw error for invalid renderedValue type', async () => {
        await expect((0, similar_1.handleSimilar)({
            assertion: {
                type: 'similar',
                value: 'test',
            },
    ...
    it('should use dot_product metric when specified', async () => {
        const mockMatchesSimilarity = require('../../src/matchers').matchesSimilarity;
        await (0, similar_1.handleSimilar)({
            assertion: {
                type: 'similar:dot',
                value: 'hello world',
            },
        ...
        expect(mockMatchesSimilarity).toHaveBeenCalledWith('hello world', 'hello world', expect.any(Number), false, expect.any(Object), 'dot_product');
    });
    it('should use euclidean metric when specified', async () => {
        ...
        expect(mockMatchesSimilarity).toHaveBeenCalledWith('hello world', 'hello world', expect.any(Number), false, expect.any(Object), 'euclidean');
    });
    it('should default to cosine metric when not specified', async () => {
        ...
        expect(mockMatchesSimilarity).toHaveBeenCalledWith('hello world', 'hello world', expect.any(Number), false, expect.any(Object), 'cosine');
    });
});
//# sourceMappingURL=similar.test.js.map