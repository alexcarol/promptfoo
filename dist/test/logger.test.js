...
describe('logger', () => {
    ...
    describe('initializeRunLogging', () => {
        ...
        it('should respect PROMPTFOO_LOG_DIR environment variable', () => {
            ...
            mockGetEnvString.mockImplementation((key, defaultValue) => {
            ...
            const resolvedCustomLogDir = path_1.default.resolve(customLogDir);
            const expectedCustomDebugFile = path_1.default.join(resolvedCustomLogDir, 'promptfoo-debug-2025-03-01_12-00-00-000Z.log');
            const expectedCustomErrorFile = path_1.default.join(resolvedCustomLogDir, 'promptfoo-error-2025-03-01_12-00-00-000Z.log');
