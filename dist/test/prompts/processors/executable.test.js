...
const executable_1 = require("../../../src/prompts/processors/executable");
...
describe('processExecutableFile', () => {
    ...
    it('should process a script with exec: prefix', async () => {
        ...
        const prompts = await (0, executable_1.processExecutableFile)(scriptPath, {});
    ...
    it('should use custom label when provided', async () => {
        ...
        const prompts = await (0, executable_1.processExecutableFile)(scriptPath, { label: 'Custom Label' });
...
echo "Test output"`;
            ...
            try {
                ...
                const prompts = await (0, executable_1.processExecutableFile)(scriptPath, { config });
