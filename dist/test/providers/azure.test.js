    ...
    describe('AzureOpenAiChatCompletionProvider', () => {
        ...
        describe('reasoning models', () => {
            ...
            it('should auto-detect o1 models by deployment name', () => {
                const provider = new chat_1.AzureChatCompletionProvider('o1-preview', {
                    config: {},
                });
                expect(provider.isReasoningModel()).toBe(true);
            });
            it('should auto-detect o3 models by deployment name', () => {
                const provider = new chat_1.AzureChatCompletionProvider('o3-mini', {
                    config: {},
                });
                expect(provider.isReasoningModel()).toBe(true);
            });
            it('should auto-detect o4 models by deployment name', () => {
                const provider = new chat_1.AzureChatCompletionProvider('o4-preview', {
                    config: {},
                });
                expect(provider.isReasoningModel()).toBe(true);
            });
            it('should auto-detect gpt-5 models by deployment name', () => {
                const provider = new chat_1.AzureChatCompletionProvider('gpt-5-mini', {
                    config: {},
                });
                expect(provider.isReasoningModel()).toBe(true);
            });
            it('should not detect non-reasoning models', () => {
                const provider = new chat_1.AzureChatCompletionProvider('gpt-4o', {
                    config: {},
                });
            ...
            it('should auto-detect prefixed o1 deployment names', () => {
                const provider = new chat_1.AzureChatCompletionProvider('prod-o1-preview', {
                    config: {},
                });
                expect(provider.isReasoningModel()).toBe(true);
            });
            it('should auto-detect prefixed gpt-5 deployment names', () => {
                const provider = new chat_1.AzureChatCompletionProvider('staging-gpt-5-mini', {
                    config: {},
                });
                expect(provider.isReasoningModel()).toBe(true);
            });
            it('should not detect non-reasoning models with similar names', () => {
                const provider = new chat_1.AzureChatCompletionProvider('gpt-4-turbo', {
                    config: {},
                });
                expect(provider.isReasoningModel()).toBe(false);
            });
