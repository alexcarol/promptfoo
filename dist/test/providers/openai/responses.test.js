...
describe('OpenAiResponsesProvider', () => {
    ...
    it('should include all expected model names', () => {
        ...
        // GPT-5.1 models
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('gpt-5.1');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('gpt-5.1-mini');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('gpt-5.1-nano');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('gpt-5.1-codex');
    ...
    describe('deep research model validation', () => {
        ...
        it('should use longer timeout for gpt-5-pro models', async () => {
            ...
            const provider = new responses_1.OpenAiResponsesProvider('gpt-5-pro', {
                config: {
                    apiKey: 'test-key',
                },
            });
