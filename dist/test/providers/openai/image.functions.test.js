...
describe('OpenAI Image Provider Functions', () => {
    ...
    describe('processApiResponse', () => {
        it('should handle error in data', async () => {
            ...
            const result = await (0, image_1.processApiResponse)(data, 'prompt', 'url', false, 'dall-e-2', '512x512', undefined);
        ...
        it('should return formatted output for successful response', async () => {
            ...
            const result = await (0, image_1.processApiResponse)(data, 'test prompt', 'url', false, 'dall-e-2', '512x512', undefined);
        ...
        it('should include base64 flags for b64_json response format', async () => {
            ...
            const result = await (0, image_1.processApiResponse)(data, 'test prompt', 'b64_json', false, 'dall-e-3', '1024x1024', undefined, 'standard');
        ...
        it('should set cost to 0 for cached responses', async () => {
            ...
            const result = await (0, image_1.processApiResponse)(data, 'test prompt', 'url', true, 'dall-e-2', '512x512', undefined);
