...
const index_1 = require("../../../src/providers/openai/index");
describe('OpenAI Provider', () => {
    describe('OpenAiGenericProvider', () => {
        const provider = new index_1.OpenAiGenericProvider('test-model', {
            config: {
                apiKey: 'test-key',
        ...
        it('should use custom API host', () => {
            const customProvider = new index_1.OpenAiGenericProvider('test-model', {
        ...
        it('should get organization from env', () => {
            ...
            const envProvider = new index_1.OpenAiGenericProvider('test-model');
